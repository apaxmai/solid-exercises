...
public class SuccessfulApplication implements JobApplicationResult
{
  ...
  {
    return new SuccessfulApplication(application.getJobseeker(), application.getJob(), application.getResume());
  }
  ...
  public boolean isFor(Jobseeker jobseeker,
                       Job job)
  {
    return (this.jobseeker.equals(jobseeker) && this.job.equals(job));
  }
